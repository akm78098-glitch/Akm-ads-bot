...
@app.route('/')
def home():
    return "🤖 Bot is alive! Art. Hachalu Hundessa Memorial School Bot."
...
def send_welcome(message):
    welcome_text = (
        ...
        f"━━━━━━━━━━━━━━━━━━━━━\n\n"
        f"📌 *How may I assist you today, Professor?*\n\n"
...
def guide_callback(call):
    guide_data = {
        "guide_exam": (
            ...
            f"━━━━━━━━━━━━━━━━━━━━━\n\n"
            f"1️⃣ Start studying *3-4 months* early\n"
            f"2️⃣ Collect & practice *past exam papers*\n"
            f"3️⃣ Study under *timed conditions*\n"
            f"4️⃣ Join or form a *study group*\n"
            f"5️⃣ Review all *mistakes carefully*\n"
            f"6️⃣ Get *7-8 hours* of sleep nightly\n"
            f"7️⃣ Eat healthy food before exams\n"
            f"8️⃣ Arrive *early* on exam day\n\n"
            f"💡 *Consistency beats cramming!*"
        ),
        "guide_scholarship": (
            f"🎓 *Scholarship Guide*\n\n"
            f"━━━━━━━━━━━━━━━━━━━━━\n\n"
            f"1️⃣ Start applying *6-12 months* early\n"
            f"2️⃣ Prepare: transcripts, recommendations, essay\n"
            f"3️⃣ Write a *powerful personal story*\n"
            f"4️⃣ Connect goals to *community needs*\n"
            f"5️⃣ Apply to *multiple* scholarships\n"
            f"6️⃣ Check government & NGO websites\n"
            f"7️⃣ Ask teachers to *review* your application\n\n"
            f"💡 *Show how you'll give back to community!*"
        ),
        "guide_study": (
            f"📚 *Best Study Techniques*\n\n"
            f"━━━━━━━━━━━━━━━━━━━━━\n\n"
            f"1️⃣ Use *active recall* — test yourself\n"
            f"2️⃣ Create *mind maps* for each topic\n"
            f"3️⃣ *Teach others* what you learn\n"
            f"4️⃣ Use the *Pomodoro Technique*\n"
            f"5️⃣ Take notes using *Cornell method*\n"
            f"6️⃣ Review material *within 24 hours*\n"
            f"7️⃣ Use *mnemonics* for memorization\n\n"
        ...
        "guide_stress": (
            f"😰 *Stress Management*\n\n"
            f"━━━━━━━━━━━━━━━━━━━━━\n\n"
            f"1️⃣ Practice *deep breathing* exercises\n"
            f"2️⃣ *Exercise* regularly — even walking helps\n"
            f"3️⃣ Break study into *small, manageable tasks*\n"
            f"4️⃣ Talk to *friends, family, or counselor*\n"
            f"5️⃣ Avoid *comparing yourself* to others\n"
            f"6️⃣ Take *regular breaks* during study\n"
            f"7️⃣ Remember: *One exam doesn't define you*\n\n"
            f"💡 *Your mental health comes first — always!*"
        ),
        "guide_time": (
            f"⏰ *Time Management*\n\n"
            f"━━━━━━━━━━━━━━━━━━━━━\n\n"
            f"1️⃣ Create a *weekly study schedule*\n"
            f"2️⃣ Use *45-minute* focused study blocks\n"
            f"3️⃣ Prioritize *difficult subjects first*\n"
            f"4️⃣ Take *10-minute breaks* between blocks\n"
            f"5️⃣ Set *SMART goals* (Specific, Measurable...)\n"
            f"6️⃣ Use the *2-minute rule* for small tasks\n"
            f"7️⃣ Remove *distractions* during study time\n\n"
            f"💡 *Small daily efforts compound into\n"
            f"massive results over time!*"
        ),
        "guide_mindset": (
            f"💡 *Growth Mindset*\n\n"
            f"━━━━━━━━━━━━━━━━━━━━━\n\n"
            f"*Fixed Mindset:* \"I'm not good at this.\"\n"
            f"*Growth Mindset:* \"I'm not good at this *yet.*\"\n\n"
            f"1️⃣ Embrace *challenges* as opportunities\n"
            f"2️⃣ Learn from *criticism and feedback*\n"
            f"3️⃣ Persist through *setbacks*\n"
            f"4️⃣ Celebrate *effort*, not just results\n"
            f"5️⃣ Be inspired by *others' success*\n\n"
            f"💡 *Your abilities can be developed\n"
...
def academic_calendar(message):
    text = (
        f"📅 *Academic Calendar*\n\n"
        f"━━━━━━━━━━━━━━━━━━━━━\n\n"
        f"🗓 *September* — New Academic Year Begins\n"
        f"🗓 *October 2* — 🎤 Hachalu Memorial Lecture\n"
        f"🗓 *December* — Mid-Semester Exams\n"
        f"🗓 *January 7* — 🇪🇹 Ethiopian Christmas (Genna)\n"
        f"🗓 *January 19* — 🇪🇹 Timket (Epiphany)\n"
        f"🗓 *February* — Semester 1 Final Exams\n"
        f"🗓 *March* — Semester Break\n"
        f"🗓 *April* — Second Semester Begins\n"
        f"🗓 *May 1* — Workers' Day\n"
        f"🗓 *June 29* — 🕯 Hachalu Memorial Day\n"
        f"🗓 *July* — Final Exams\n"
        f"🗓 *August* — 🎓 Graduation Ceremony\n\n"
        f"━━━━━━━━━━━━━━━━━━━━━\n\n"
        f"📌 *Dates may vary slightly each year.*"
    )
    bot.send_message(message.chat.id, text, parse_mode="Markdown")
...
def achievements(message):
    text = (
        ...
        f"🎓 *Top Student Achievements:*\n"
        f"• Tolosa Gudeta — Regional Competition 🥇\n"
        f"• Bontu Tadesse — National TVET Scholarship\n"
        f"• Gammachiis Lemma — Entrepreneurship Award\n"
        f"• Faaya Gutama — Employed by Leading Firm\n"
...
def contact(message):
    text = (
        ...
        f"📞 *Phone:*\n"
        f"(To be updated by school administration)\n\n"
        f"✉️ *Email:*\n"
        f"(To be updated by school administration)\n\n"
        f"━━━━━━━━━━━━━━━━━━━━━\n\n"
        f"🌐 *Visit our website to send a message!*\n"
        f"📌 *Contact form available 24/7*"
    )
    bot.send_message(message.chat.id, text, parse_mode="Markdown")
...
if __name__ == '__main__':
    # Start Flask in background + Telegram polling
    import threading
