...
async def on_startup():
    if BOT_TOKEN:
        webhook_url = f"https://akm-ads-bot.onrender.com{WEBHOOK_PATH}"
        async with httpx.AsyncClient() as client:
            response = await client.post(f"https://api.telegram.org/bot{BOT_TOKEN}/setWebhook", params={"url": webhook_url})
